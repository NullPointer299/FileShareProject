    ...
    <div class="content">
        <form action="Login" method="post">
            <fieldset class="login">
                ...
                <div class="info">
                    <div class="form"><label for="id" class="form">ID</label><input id="id" min="5" maxlength="10"
                                                                                    type="text"
                                                                                    placeholder=" ユーザIDを入力してください"
                                                                                    required name="id"></div>

                    <div class="form"><label for="password" class="form">パスワード</label><input id="password"
                                                                                             type="password"
